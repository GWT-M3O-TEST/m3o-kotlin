...
@Serializable
data class SunnahBook(val name: String, val arabic_name: String, val hadiths: Int, val id: Int)
@Serializable
data class SunnahBooksRequest(val page: Int, val collection: String, val limit: Int)
@Serializable
...
@Serializable
data class SunnahChaptersResponse(val chapters: List<SunnahChapter>, val collection: String, val limit: Int, val page: Int, val total: Int, val book: Int)
@Serializable
...
@Serializable
data class SunnahHadith(val chapter_key: String, val chapter_title: String, val id: Int, val text: String, val arabic_chapter_title: String, val arabic_text: String, val chapter: Int)
@Serializable
