...
@Serializable
data class NewsArticle(val snippet: String, val source: String, val title: String, val description: String, val id: String, val locale: String, val published_at: String, val url: String, val categories: List<String>, val image_url: String, val keywords: String, val language: String)
@Serializable
