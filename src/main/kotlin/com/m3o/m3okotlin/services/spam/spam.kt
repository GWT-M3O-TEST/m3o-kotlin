...
@Serializable
internal data class SpamClassifyRequest(val subject: String, val text_body: String, val to: String, val email_body: String, val from: String, val html_body: String)
@Serializable
