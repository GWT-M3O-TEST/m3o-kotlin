...
@Serializable
data class DnsQueryResponse(val TC: Boolean, val answer: List<DnsAnswer>, val status: Int, val CD: Boolean, val RA: Boolean, val RD: Boolean, val AD: Boolean, val provider: String, val question: List<DnsQuestion>)
@Serializable
