...
@Serializable
internal data class SunnahBook(val id: Int, val name: String, val arabic_name: String, val hadiths: Int)
@Serializable
...
@Serializable
data class SunnahHadithsResponse(val collection: String, val hadiths: List<SunnahHadith>, val limit: Int, val page: Int, val total: Int, val book: Int)
