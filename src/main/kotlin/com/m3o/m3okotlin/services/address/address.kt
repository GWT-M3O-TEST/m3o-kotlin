...
@Serializable
data class AddressRecord(val line_one: String, val line_two: String, val locality: String, val organisation: String, val summary: String, val building_name: String, val county: String, val street: String, val town: String, val postcode: String, val premise: String)
