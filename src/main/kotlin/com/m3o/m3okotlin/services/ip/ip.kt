...
@Serializable
data class IpLookupResponse(val city: String, val continent: String, val country: String, val ip: String, val latitude: Double, val longitude: Double, val timezone: String, val asn: Int)
