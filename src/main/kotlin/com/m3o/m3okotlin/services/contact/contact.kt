...
@Serializable
data class ContactContactInfo(val name: String, val updated_at: String, val addresses: List<ContactAddress>, val created_at: String, val id: String, val links: List<ContactLink>, val social_medias: List<ContactSocialMedia>, val birthday: String, val emails: List<ContactEmail>, val note: String, val phones: List<ContactPhone>)
@Serializable
data class ContactCreateRequest(val note: String, val phones: List<ContactPhone>, val social_medias: List<ContactSocialMedia>, val addresses: List<ContactAddress>, val birthday: String, val emails: List<ContactEmail>, val links: List<ContactLink>, val name: String)
@Serializable
...
@Serializable
data class ContactUpdateRequest(val birthday: String, val emails: List<ContactEmail>, val id: String, val links: List<ContactLink>, val note: String, val addresses: List<ContactAddress>, val name: String, val phones: List<ContactPhone>, val social_medias: List<ContactSocialMedia>)
@Serializable
