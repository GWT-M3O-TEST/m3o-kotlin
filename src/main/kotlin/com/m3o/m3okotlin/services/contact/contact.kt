...
@Serializable
data class ContactContactInfo(val addresses: List<ContactAddress>, val created_at: String, val emails: List<ContactEmail>, val id: String, val phones: List<ContactPhone>, val birthday: String, val links: List<ContactLink>, val name: String, val note: String, val social_medias: List<ContactSocialMedia>, val updated_at: String)
@Serializable
...
@Serializable
data class ContactUpdateRequest(val addresses: List<ContactAddress>, val birthday: String, val emails: List<ContactEmail>, val id: String, val note: String, val phones: List<ContactPhone>, val links: List<ContactLink>, val name: String, val social_medias: List<ContactSocialMedia>)
@Serializable
