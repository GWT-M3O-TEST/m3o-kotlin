...
@Serializable
data class EvchargersAddress(val town: String, val access_comments: String, val lat_lng: String, val location: EvchargersCoordinates, val postcode: String, val title: String, val address_line_1: String, val address_line_2: String, val country: EvchargersCountry, val country_id: String, val state_or_province: String)
@Serializable
...
@Serializable
data class EvchargersConnection(val reference: String, val amps: Double, val connection_type: EvchargersConnectionType, val connection_type_id: String, val level: EvchargersChargerType, val level_id: String, val current: String, val power: Double, val voltage: Double)
@Serializable
...
@Serializable
data class EvchargersOperator(val phone_secondary: String, val title: String, val contact_email: String, val fault_report_email: String, val id: String, val is_private_individual: Boolean, val comments: String, val phone_primary: String, val website: String)
@Serializable
data class EvchargersPoi(val operator: EvchargersOperator, val operator_id: String, val usage_type: EvchargersUsageType, val num_points: Long, val usage_type_id: String, val address: EvchargersAddress, val connections: List<EvchargersConnection>, val cost: String, val data_provider_id: String, val id: String)
@Serializable
data class EvchargersReferenceDataResponse(val status_types: List<EvchargersStatusType>, val charger_types: List<EvchargersChargerType>, val checkin_status_types: List<EvchargersCheckinStatusType>, val connection_types: List<EvchargersConnectionType>, val countries: List<EvchargersCountry>, val current_types: List<EvchargersCurrentType>, val data_providers: List<EvchargersDataProvider>, val operators: List<EvchargersOperator>, val submission_status_types: List<EvchargersSubmissionStatusType>, val usage_types: List<EvchargersUsageType>, val user_comment_types: List<EvchargersUserCommentType>)
@Serializable
data class EvchargersSearchRequest(val min_power: Long, val distance: Long, val levels: List<String>, val location: EvchargersCoordinates, val max_results: Long, val usage_types: List<String>, val box: EvchargersBoundingBox, val connection_types: List<String>, val country_id: String, val operators: List<String>)
@Serializable
