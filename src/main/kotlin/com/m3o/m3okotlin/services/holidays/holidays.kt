...
@Serializable
data class HolidaysHoliday(val name: String, val regions: List<HolidaysString>, val types: List<HolidaysString>, val country_code: String, val date: String, val local_name: String)
@Serializable
