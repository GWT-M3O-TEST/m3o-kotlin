...
@Serializable
data class AddressRecord(val locality: String, val organisation: String, val postcode: String, val street: String, val premise: String, val summary: String, val town: String, val building_name: String, val county: String, val line_one: String, val line_two: String)
