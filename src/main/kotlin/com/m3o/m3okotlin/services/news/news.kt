...
@Serializable
data class NewsArticle(val image_url: String, val keywords: String, val locale: String, val source: String, val title: String, val url: String, val categories: List<NewsString>, val id: String, val published_at: String, val snippet: String, val description: String, val language: String)
@Serializable
