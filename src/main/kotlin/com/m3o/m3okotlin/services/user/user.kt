...
@Serializable
internal data class UserAccount(val verified: Boolean, val created: Long, val email: String, val id: String, val profile: Map<String, String>, val updated: Long, val username: String, val verification_date: Long)
@Serializable
...
@Serializable
internal data class UserLoginRequest(val username: String, val email: String, val password: String)
@Serializable
...
@Serializable
internal data class UserReadRequest(val username: String, val email: String, val id: String)
@Serializable
...
@Serializable
internal data class UserResetPasswordRequest(val new_password: String, val code: String, val confirm_password: String, val email: String)
@Serializable
data class UserResetPasswordResponse()
@Serializable
internal data class UserSendMagicLinkRequest(val endpoint: String, val from_name: String, val subject: String, val text_content: String, val address: String, val email: String)
@Serializable
...
@Serializable
internal data class UserUpdateRequest(val profile: Map<String, String>, val username: String, val email: String, val id: String)
@Serializable
