...
@Serializable
data class DnsQueryResponse(val CD: Boolean, val RA: Boolean, val RD: Boolean, val TC: Boolean, val answer: List<DnsAnswer>, val question: List<DnsQuestion>, val status: Int, val AD: Boolean, val provider: String)
@Serializable
