...
@Serializable
data class UserAccount(val email: String, val id: String, val profile: Map<String, String>, val updated: Long, val username: String, val verification_date: Long, val verified: Boolean, val created: Long)
@Serializable
...
@Serializable
class UserResetPasswordResponse()
@Serializable
...
@Serializable
class UserSendMagicLinkResponse()
@Serializable
data class UserSendPasswordResetEmailRequest(val text_content: String, val email: String, val expiration: Long, val from_name: String, val subject: String)
@Serializable
class UserSendPasswordResetEmailResponse()
@Serializable
data class UserSendVerificationEmailRequest(val subject: String, val text_content: String, val email: String, val failure_redirect_url: String, val from_name: String, val redirect_url: String)
@Serializable
class UserSendVerificationEmailResponse()
@Serializable
data class UserSession(val created: Long, val expires: Long, val id: String, val userId: String)
@Serializable
data class UserUpdatePasswordRequest(val userId: String, val confirm_password: String, val new_password: String, val old_password: String)
@Serializable
