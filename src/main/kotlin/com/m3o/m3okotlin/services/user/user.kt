...
@Serializable
data class UserAccount(val verification_date: Long, val verified: Boolean, val created: Long, val email: String, val id: String, val profile: Map<String, String>, val updated: Long, val username: String)
@Serializable
...
@Serializable
data class UserResetPasswordRequest(val email: String, val new_password: String, val code: String, val confirm_password: String)
@Serializable
data class UserResetPasswordResponse()
@Serializable
data class UserSendMagicLinkRequest(val subject: String, val text_content: String, val address: String, val email: String, val endpoint: String, val from_name: String)
@Serializable
data class UserSendMagicLinkResponse()
@Serializable
data class UserSendPasswordResetEmailRequest(val expiration: Long, val from_name: String, val subject: String, val text_content: String, val email: String)
@Serializable
