...
@Serializable
data class AddressRecord(val building_name: String, val line_one: String, val line_two: String, val premise: String, val street: String, val summary: String, val town: String, val county: String, val locality: String, val organisation: String, val postcode: String)
