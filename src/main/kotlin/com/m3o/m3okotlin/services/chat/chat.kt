...
@Serializable
data class ChatMessage(val user_id: String, val client: String, val id: String, val room_id: String, val sent_at: String, val subject: String, val text: String)
@Serializable
data class ChatRoom(val description: String, val id: String, val name: String, val private: Boolean, val user_ids: List<ChatString>, val created_at: String)
@Serializable
