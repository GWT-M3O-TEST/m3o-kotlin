...
@Serializable
data class NftAsset(val token_id: String, val id: Int, val listing_date: String, val name: String, val collection: NftCollection, val description: String, val permalink: String, val contract: NftContract, val image_url: String, val presale: Boolean, val sales: Int, val traits: List<NftMap<String, dynamic>>, val creator: NftUser, val last_sale: NftSale, val owner: NftUser)
@Serializable
...
@Serializable
data class NftCollection(val editors: List<NftString>, val image_url: String, val payment_tokens: List<NftToken>, val slug: String, val external_link: String, val seller_fees: String, val traits: NftMap<String, dynamic>, val name: String, val primary_asset_contracts: List<NftContract>, val stats: NftMap<String, dynamic>, val banner_image_url: String, val created_at: String, val description: String, val payout_address: String, val safelist_request_status: String)
@Serializable
...
@Serializable
data class NftContract(val payout_address: String, val symbol: String, val description: String, val name: String, val owner: Int, val schema: String, val seller_fees: String, val type: String, val address: String, val created_at: String)
@Serializable
...
@Serializable
data class NftSale(val event_type: String, val payment_token: NftToken, val total_price: String, val quantity: String, val transaction: NftTransaction, val asset_decimals: Int, val asset_token_id: String, val created_at: String, val event_timestamp: String)
@Serializable
