...
@Serializable
data class TimeZoneResponse(val dst: Boolean, val localtime: String, val location: String, val region: String, val abbreviation: String, val country: String, val offset: Int, val timezone: String, val latitude: Double, val longitude: Double)
