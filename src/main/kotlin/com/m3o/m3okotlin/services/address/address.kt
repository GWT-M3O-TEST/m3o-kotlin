...
@Serializable
data class AddressRecord(val building_name: String, val line_one: String, val line_two: String, val locality: String, val postcode: String, val town: String, val county: String, val organisation: String, val premise: String, val street: String, val summary: String)
