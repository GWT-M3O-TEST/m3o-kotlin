...
@Serializable
data class StockHistoryResponse(val date: String, val high: Double, val low: Double, val open: Double, val symbol: String, val volume: Int, val close: Double)
@Serializable
...
@Serializable
data class StockQuoteResponse(val symbol: String, val timestamp: String, val ask_price: Double, val ask_size: Int, val bid_price: Double, val bid_size: Int)
