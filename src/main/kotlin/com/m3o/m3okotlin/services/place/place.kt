...
@Serializable
data class PlaceResult(val vicinity: String, val icon_url: String, val location: String, val open_now: Boolean, val opening_hours: List<PlaceString>, val rating: Double, val type: String, val types: List<PlaceString>, val address: String, val name: String)
@Serializable
