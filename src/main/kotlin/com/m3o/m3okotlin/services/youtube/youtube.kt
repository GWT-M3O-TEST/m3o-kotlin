...
@Serializable
data class YoutubeSearchResult(val broadcasting: String, val channel_title: String, val id: String, val title: String, val url: String, val channel_id: String, val description: String, val kind: String, val published_at: String)
