...
@Serializable
data class SunnahHadith(val arabic_chapter_title: String, val arabic_text: String, val chapter: Int, val chapter_key: String, val chapter_title: String, val id: Int, val text: String)
@Serializable
