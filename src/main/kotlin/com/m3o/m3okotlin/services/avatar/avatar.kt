...
@Serializable
internal data class AvatarGenerateRequest({/// avatar's gender: `male` or `female`; default is `male`
...
String? username, /// encode format of avatar image: `png` or `jpeg`; default is `jpeg`
String? format,})
@Serializable
data class AvatarGenerateResponse({/// M3O's CDN url of the avatar image
String? url, /// base64 encoded string of the avatar image
String? base64,})
