...
@Serializable
data class YoutubeSearchResult(val channel_title: String, val channel_id: String, val description: String, val id: String, val kind: String, val published_at: String, val title: String, val url: String, val broadcasting: String)
