...
@Serializable
data class ContactContactInfo(val birthday: String, val id: String, val name: String, val phones: List<ContactPhone>, val social_medias: List<ContactSocialMedia>, val updated_at: String, val addresses: List<ContactAddress>, val created_at: String, val emails: List<ContactEmail>, val links: List<ContactLink>, val note: String)
@Serializable
...
@Serializable
data class ContactLink(val url: String, val label: String)
@Serializable
...
@Serializable
data class ContactSocialMedia(val username: String, val label: String)
@Serializable
data class ContactUpdateRequest(val addresses: List<ContactAddress>, val birthday: String, val name: String, val note: String, val social_medias: List<ContactSocialMedia>, val emails: List<ContactEmail>, val id: String, val links: List<ContactLink>, val phones: List<ContactPhone>)
@Serializable
