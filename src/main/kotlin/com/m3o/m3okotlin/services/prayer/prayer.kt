...
String? asr,})
@Serializable
internal data class PrayerTimesRequest({/// optional date in YYYY-MM-DD format, otherwise uses today
String? date, /// number of days to request times for
