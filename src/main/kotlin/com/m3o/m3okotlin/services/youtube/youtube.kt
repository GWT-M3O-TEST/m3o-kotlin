...
@Serializable
data class YoutubeSearchResult(val channel_id: String, val description: String, val id: String, val published_at: String, val title: String, val broadcasting: String, val channel_title: String, val kind: String, val url: String)
