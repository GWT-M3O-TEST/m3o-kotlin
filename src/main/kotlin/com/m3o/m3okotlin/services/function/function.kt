...
@Serializable
data class FunctionDeployRequest(val branch: String, val entrypoint: String, val name: String, val source: String, val env_vars: Map<String, String>, val region: String, val repo: String, val runtime: String, val subfolder: String)
@Serializable
...
@Serializable
data class FunctionFunc(val entrypoint: String, val name: String, val source: String, val status: String, val env_vars: Map<String, String>, val updated: String, val repo: String, val branch: String, val created: String, val id: String, val region: String, val runtime: String, val subfolder: String, val url: String)
@Serializable
