...
@Serializable
data class HolidaysHoliday(val types: List<String>, val country_code: String, val date: String, val local_name: String, val name: String, val regions: List<String>)
@Serializable
