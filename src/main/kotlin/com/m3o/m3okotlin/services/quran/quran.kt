...
@Serializable
data class QuranChapter(val arabic_name: String, val complex_name: String, val id: Int, val name: String, val translated_name: String, val pages: List<QuranInt>, val prefix_bismillah: Boolean, val revelation_order: Int, val revelation_place: String, val verses: Int)
@Serializable
...
@Serializable
data class QuranVerse(val translations: List<QuranTranslation>, val transliteration: String, val words: List<QuranWord>, val page: Int, val text: String, val translated_text: String, val id: Int, val interpretations: List<QuranInterpretation>, val key: String, val number: Int)
@Serializable
...
@Serializable
data class QuranWord(val transliteration: String, val id: Int, val line: Int, val text: String, val translation: String, val char_type: String, val code: String, val page: Int, val position: Int)
