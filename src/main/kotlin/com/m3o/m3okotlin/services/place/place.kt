...
@Serializable
data class PlaceResult(val icon_url: String, val name: String, val opening_hours: List<String>, val rating: Double, val types: List<String>, val address: String, val open_now: Boolean, val type: String, val vicinity: String, val location: String)
@Serializable
