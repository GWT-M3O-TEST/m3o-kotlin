...
@Serializable
data class NewsArticle(val published_at: String, val categories: List<NewsString>, val description: String, val id: String, val language: String, val source: String, val title: String, val url: String, val image_url: String, val keywords: String, val locale: String, val snippet: String)
@Serializable
