...
@Serializable
data class DnsQueryResponse(val provider: String, val AD: Boolean, val CD: Boolean, val RA: Boolean, val question: List<DnsQuestion>, val status: Int, val RD: Boolean, val TC: Boolean, val answer: List<DnsAnswer>)
@Serializable
