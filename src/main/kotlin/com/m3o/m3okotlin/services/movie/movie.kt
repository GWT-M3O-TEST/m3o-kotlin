...
@Serializable
data class MovieMovieInfo(val popularity: Double, val poster_path: String, val video: Boolean, val original_title: String, val release_date: String, val title: String, val vote_average: Double, val adult: Boolean, val backdrop_path: String, val genre_ids: List<Int>, val id: Int, val original_language: String, val overview: String, val vote_count: Int)
@Serializable
