...
@Serializable
class PostcodeRandomRequest()
@Serializable
data class PostcodeRandomResponse(val postcode: String, val region: String, val ward: String, val country: String, val district: String, val latitude: Double, val longitude: Double)
@Serializable
