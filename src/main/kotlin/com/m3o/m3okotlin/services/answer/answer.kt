...
@Serializable
data class AnswerQuestionRequest(val query: String? = null)
@Serializable
data class AnswerQuestionResponse(val answer: String? = null, val image: String? = null, val url: String? = null)
