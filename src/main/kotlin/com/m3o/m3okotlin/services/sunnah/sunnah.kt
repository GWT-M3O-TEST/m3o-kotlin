...
@Serializable
internal data class SunnahChapter(val key: String, val title: String, val arabic_title: String, val book: Int, val id: Int)
@Serializable
internal data class SunnahChaptersRequest(val page: Int, val book: Int, val collection: String, val limit: Int)
@Serializable
