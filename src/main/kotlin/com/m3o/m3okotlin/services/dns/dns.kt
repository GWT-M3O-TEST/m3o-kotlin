...
@Serializable
data class DnsQueryResponse(val AD: Boolean, val RD: Boolean, val status: Int, val CD: Boolean, val RA: Boolean, val TC: Boolean, val answer: List<DnsAnswer>, val provider: String, val question: List<DnsQuestion>)
@Serializable
