...
@Serializable
data class ContactContactInfo(val birthday: String, val emails: List<ContactEmail>, val links: List<ContactLink>, val note: String, val phones: List<ContactPhone>, val social_medias: List<ContactSocialMedia>, val updated_at: String, val addresses: List<ContactAddress>, val created_at: String, val id: String, val name: String)
@Serializable
...
@Serializable
data class ContactUpdateRequest(val birthday: String, val emails: List<ContactEmail>, val id: String, val name: String, val note: String, val social_medias: List<ContactSocialMedia>, val addresses: List<ContactAddress>, val links: List<ContactLink>, val phones: List<ContactPhone>)
@Serializable
