...
@Serializable
data class UserAccount(val profile: Map<String, String>, val updated: Long, val username: String, val verification_date: Long, val verified: Boolean, val created: Long, val email: String, val id: String)
@Serializable
