...
@Serializable
class HolidaysCountriesRequest()
@Serializable
...
@Serializable
data class HolidaysHoliday(val regions: List<HolidaysString>, val types: List<HolidaysString>, val country_code: String, val date: String, val local_name: String, val name: String)
@Serializable
