...
@Serializable
data class HolidaysHoliday(val date: String, val local_name: String, val name: String, val regions: List<String>, val types: List<String>, val country_code: String)
@Serializable
