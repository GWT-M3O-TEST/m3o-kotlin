...
@Serializable
data class DnsQueryResponse(val RD: Boolean, val question: List<DnsQuestion>, val RA: Boolean, val TC: Boolean, val answer: List<DnsAnswer>, val provider: String, val status: Int, val AD: Boolean, val CD: Boolean)
@Serializable
