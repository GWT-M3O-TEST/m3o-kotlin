...
@Serializable
data class DnsQueryResponse(val AD: Boolean, val CD: Boolean, val RA: Boolean, val RD: Boolean, val question: List<DnsQuestion>, val TC: Boolean, val answer: List<DnsAnswer>, val provider: String, val status: Int)
@Serializable
