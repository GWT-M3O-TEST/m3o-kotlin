...
@Serializable
data class MinecraftPingResponse(val players: Int, val protocol: Int, val sample: List<MinecraftPlayerSample>, val version: String, val favicon: String, val latency: Int, val max_players: Int, val motd: String)
@Serializable
